...
- Luego también veremos conceptos como OOP, el Manejo de errores, List Comprenhensions, funciones Lammda, Generadores y Decoradores, que son fundamentales en Python y ayudarán a escribir código más eficiente. o como quien dice Codigo bonito.
# PYTHON EN DATA SCIENCE
- Estos son algunos de los terminos que van a escuchar en DS, la Exploración de datos, el Procesamiento del Lenguaje Natural (Natural Language Processing en inglés), La visualización de datos que es los graficos que se extraen de los datos y por lo tanto diferente a la visión por computadora que es un campo de la inteligencia artificial que se enfoca en enseñar a las computadoras a interpretar y comprender imágenes y videos.
- Machine learning y deep learning, mientras que el Machine Learning se basa en modelos más simples y requiere menos datos en general, el Deep Learning se destaca en la capacidad de aprender representaciones complejas de datos.
- "Big Data" es un término que se utiliza para describir conjuntos de datos extremadamente grandes y complejos, vamos a tocar cada uno de ellos de manera superficial para brindar una idea de como se podria aplicar.
### La Exproración de datos
- La Exproración de datos que también es conocida como EDA (Exploratory Data Analysis), es una fase fundamental en el proceso de análisis de datos el objetivo principal es comprender y familiarizarse con los datos antes de realizar análisis más avanzados como modelajes.
    ...
    - **Análisis de Valores Extremos**: Identificar valores atípicos que pueden ser errores o indicar información importante también llamados outliers.
...
### Visualización
- La visualización de datos se refiere a la representación gráfica de datos numéricos o información para ayudar a comprender patrones, tendencias y relaciones en los datos.
- En Python, se utilizan bibliotecas para crear gráficos y visualizaciones que ayuden a analizar y comunicar los datos de manera efectiva.
- Aqui tenemos dos librerias que facilitan la visualización de los datos Matplotlib y Plotly.
- Matplotlib es una biblioteca poderosa y ampliamente utilizada para visualización de datos estática, mientras que Plotly se destaca por su capacidad de crear visualizaciones de datos interactivas y dinámicas, lo que lo hace ideal para aplicaciones web y paneles de control.
- La elección entre estas dos bibliotecas depende de tus necesidades específicas de visualización y el nivel de interactividad que deseas ofrecer en tus gráficos.
### Machine Learning
...
- **La reducción de dimensionalidad** es una tecnica usada en ML en el cual se reduce el número de variables o características en un conjunto de datos sin perder demasiada información. Esto puede ayudar a simplificar modelos y reducir el riesgo de sobreajuste.
...
- (Natural Language Processing en inglés), es una rama de la inteligencia artificial que se ocupa de la interacción entre las computadoras y el lenguaje humano.
    ...
    - El NLP puede utilizarse para resumir grandes cantidades de texto de manera automática.
    ...
    - En la creación de contenido automático, como generación de texto para chatbots o incluso escritura de noticias,
    - NLP se utiliza para generar texto coherente y relevante.
...
- SpaCy es una herramienta de programación en Python que ayuda a las computadoras a entender y trabajar con texto en lenguaje humano. Puede ayudar a dividir el texto en palabras, encontrar el significado de las palabras y mucho más. (OpenAI)
### Computer vision
...
### Big Data
- "Big Data" es un término que se refiere especificamente a conjuntos de datos extremadamente grandes y complejos que son difíciles de manejar y analizar con herramientas tradicionales de procesamiento de datos.
...
- Estos conjuntos enormes de datos suelen ser tan grandes y rápidos que resulta desafiante almacenarlos, gestionarlos y analizarlos de manera efectiva con métodos convencionales.
...
# Manejo de errores
El manejo de errores en Python se refiere a la capacidad que un programador tiene para lidiar con situaciones excepcionales o errores que puedan ocurrir durante la ejecución. 
...
- La diferencia clave entre raise y assert es que raise se usa para generar una excepción cuando se detecta una condición excepcional, mientras que assert se usa para testing o para verificar que una condición es verdadera y, si no lo es, genera una excepción.
- raise es más flexible y se utiliza para generar excepciones como lo podemos ver aqui, mientras que assert es una forma más concisa de realizar verificaciones en el código.
...
# List comprehensions
Las comprenciones de listas son una forma elegante y eficiente de construir listas en una sola línea de código. Se utilizan para aplicar una expresión a cada elemento de una secuencia (como una lista, tupla o rango) y crear una nueva lista a partir de los resultados.
`nueva_lista = [expresion for elemento in secuencia if condicion]`
- Expresion es la expresión que se aplica a cada elemento
...
# Funciones Lambda
- Las funciones lambda, también conocidas como expresiones o funciones anónimas, son funciones pequeñas y anónimas en Python que se definen utilizando la palabra clave lambda.
- A diferencia de las funciones normales que se definen con la palabra clave def, las funciones lambda se utilizan para crear funciones simples y de una sola línea sin necesidad de darles un nombre.
...
- En resumen, los generadores son una forma eficiente de crear secuencias de elementos en Python, especialmente cuando necesitas trabajar con grandes conjuntos de datos y deseas ahorrar memoria.
- Utilizan la palabra clave yield para crear funciones generadoras y se pueden iterar mediante bucles o next() para obtener elementos de manera incremental.
# Decoradores
- Es una función que extiende la funcionalidad de otra función simple y llanamente es una funcion que modifica una función.
- y se distinguen por @.
